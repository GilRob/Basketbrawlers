...
Knight::Knight(const std::string& bodyName, const std::string& textureName) {
	type = 1;
...
Transform Knight::nSpecial(bool charging)
{
	//CHARGABLE SPECIAL
	int maxCharge = 170;
	int endlag = 33;
